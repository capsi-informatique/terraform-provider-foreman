...
- `location_ids` - (Optional) IDs of the locations associated with this hostgroup.
...
- `organization_ids` - (Optional) IDs of the organizations associated with this hostgroup.
